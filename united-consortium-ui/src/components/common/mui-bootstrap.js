...
FormControl.Feedback = ({ children, ...props }) => <FormHelperText error {...props}>{children}</FormHelperText>;
...
const Tabs = ({ defaultActiveKey, children, onSelect }) => {
    ...
    return <TabsContext.Provider value={{ activeKey, setActiveKey }}>
...
const MuiTabs = require('@mui/material/Tabs').default;
const MuiTab = require('@mui/material/Tab').default;
...
export { Alert, Accordion, Badge, Button, Card, Col, Container, Dropdown, Form, FormControl, ListGroup, Modal, NavDropdown, Row, Tab, Tabs };
